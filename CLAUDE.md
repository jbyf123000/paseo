...
| [docs/antigravity-cli-integration.md](docs/antigravity-cli-integration.md) | Antigravity CLI (`agy`) integration options: headless stream-json, ACP gap, ToS risk, phased plan                              |
